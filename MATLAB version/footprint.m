...
switch r
    ...
    case 6
        %[x,feval,exitflag]=fsolve(@foot6, [0.118583701348422,0.197899216318674,0.702976002908573,0.0070862593777876,0.0920385213949654], options, p);
        [x,feval,exitflag]=fsolve(@foot6, [0.05,0.25,0.25,0.25,0.25], options, p);
        disp('p=')
        disp(x(1))
        disp('R %=')
        disp(100*x(2))
